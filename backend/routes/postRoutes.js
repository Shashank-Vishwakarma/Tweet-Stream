...
import { createPost, getPostsOfFollowedUsers, deletePost, likeOrUnlikePost, commentOnPost, getAllComments } from '../controllers/postController.js';
...
postRoutes.get('/all', protectRoutewithJwt, getPostsOfFollowedUsers);
